...
* http://portal.acm.org/citation.cfm?id_t=129906                                 *
*                                                                              *
  ...
  while (m_CurrentLM != m_MinimaList.end() && (m_CurrentLM->Y == botY))
  {
      ...
      m_GhostJoins.size() > 0 && (rb->WindDelta != 0))
    {
      for (JoinList::size_type i = 0; i < m_GhostJoins.size(); ++i)
      {
        ...
        //the 'ghost' segment to a real segment ready for later ...
...
void Clipper::AppendPolygon(TEdge *e1, TEdge *e2)
{
  ...
  //segment e2 poly onto e1 poly and delete pointers to e2 ...
    ...
    else
    {
      ...
      {  
          ...
          (ePrev->Curr.X == e->Curr.X) && (ePrev->WindDelta != 0))
        {
          ...
          AddJoin(op, op2, pt); //StrictlySimple (type-3) segment
        }
      }
